    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="#">اضافة ولي امر</a></li>
                    <li><a class="slide-item" href="#">عرض اوليا الامور</a></li>
                </ul>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="#">الايتام</a></li>
                    <li><a class="slide-item" href="#">الكافلين</a></li>
                     <li><a class="slide-item" href="#">اوياء الامور</a></li>
                </ul>
            </li>
